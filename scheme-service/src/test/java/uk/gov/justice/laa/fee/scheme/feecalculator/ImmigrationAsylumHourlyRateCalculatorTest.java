...
class ImmigrationAsylumHourlyRateCalculatorTest {
  ...
  static Stream<Arguments> feeTestData() {
    return Stream.of(
        Arguments.of(true, null, 166.25, 123.38, 24.67,          // under profit costs and disbursements limits
            429.02, 46.83, 234.14, 166.25, 123.38, List.of()),
        Arguments.of(true, "priorAuth", 919.16, 123.38, 24.67,   // over profit costs limit with prior auth
            1332.51, 197.41, 987.05, 919.16, 123.38, List.of()),
        Arguments.of(true, null, 919.16, 123.38, 24.67,          // over profit costs limit without prior auth
            1189.52, 173.58, 867.89, 800.00, 123.38, List.of("warning net profit costs")),
        Arguments.of(true, "priorAuth", 166.25, 425.17, 85.03,   // over disbursements limit with prior auth
            791.17, 46.83, 234.14, 166.25, 425.17, List.of()),
        Arguments.of(true, null, 166.25, 425.17, 85.03,          // over disbursements limit without prior auth
            766.00, 46.83, 234.14, 166.25, 400.00, List.of("warning net disbursements")),
        Arguments.of(true, "priorAuth", 919.16, 425.17, 85.03,   // over profit costs and disbursements limits with prior auth
            1694.66, 197.41, 987.05, 919.16, 425.17, List.of()),
        Arguments.of(true, null, 919.16, 425.17, 85.03,          // over profit costs and disbursements limits without prior auth
