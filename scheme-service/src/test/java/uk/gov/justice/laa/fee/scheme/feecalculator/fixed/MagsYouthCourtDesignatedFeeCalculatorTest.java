...
class MagsYouthCourtDesignatedFeeCalculatorTest {
  ...
  class designatedTest {
    ...
    static Stream<Arguments> testDataMagsDesignated() {
      return Stream.of(
          argumentsDesignated("PROJ5, designated, including VAT", "PROJ5", true, 463.22, 57.2),
          argumentsDesignated("PROJ5, designated, excluding VAT", "PROJ5", false, 406.02, 0)
      );
    }

    static Stream<Arguments> testDataYouthDesignated() {
      return Stream.of(
          argumentsDesignated("YOUL1, designated, including VAT", "YOUL1", true, 1489.4, 228.23),
          argumentsDesignated("YOUL1, designated, excluding VAT", "YOUL1", false, 1261.17, 0)
      );
    }

    private static Arguments argumentsDesignated(String scenario, String feeCode, boolean vat, double expectedTotal, double expectedVat) {
  ...
  class undesignatedTest {
    ...
    static Stream<Arguments> testDataMagsUndesignated() {
      return Stream.of(
          argumentsUndesignated("PROE1, Undesignated, including VAT", "PROE1", true, 520.66, 66.78,
              50.0, 60.0, 50.0, 60.0),
          argumentsUndesignated("PROE1, Undesignated, excluding VAT", "PROE1", false, 453.88, 0,
              50.0, 60.0, 50.0, 60.0),
          argumentsUndesignated("PROE1, Undesignated, no travel or waiting", "PROE1", true, 388.66, 44.78,
              null, null, 0, 0)
      );
    }
    ...
    static Stream<Arguments> testDataYouthUndesignated() {
      return Stream.of(
          argumentsUndesignated("YOUE3, Undesignated, including VAT", "YOUE3", true, 1355.95, 205.99,
              50.0, 60.0, 50.0, 60.0),
          argumentsUndesignated("YOUE3, Undesignated, excluding VAT", "YOUE3", false, 1149.96, 0,
              50.0, 60.0, 50.0, 60.0),
          argumentsUndesignated("YOUE3, Undesignated, no travel or waiting", "YOUE3", true, 1223.95, 183.99,
              null, null, 0, 0)
      );
    }

    private static Arguments argumentsUndesignated(String scenario, String feeCode, boolean vat, double expectedTotal, double expectedVat,
    ...
    private FeeCalculationRequest buildRequestUndesignated(String feeCode, boolean vatIndicator, Double requestedNetTravel, Double requestedNetWaiting) {
      return FeeCalculationRequest.builder()
          .feeCode(feeCode)
          .claimId("claim_123")
          .startDate(LocalDate.of(2025, 7, 29))
    ...
    void calculate_when_MagistratesCourt_Undesignated(
      ...
      FeeCalculationRequest feeCalculationRequest = buildRequestUndesignated(feeCode, vatIndicator, requestedNetTravel, requestedNetWaiting);
