...
VALUES ('ASSA', 'Mediation Assesment (alone)', 87.00, NULL, NULL, 'MED_FS2013', 'MEDIATION', 'FIXED'),
       ...
       ('MDAS2C', 'All issues sole - 2 parties eligible, agreement on Child only', NULL, 294.00, 882.00, 'MED_FS2013', 'MEDIATION', 'FIXED'),
...
VALUES ('MDAC1C', 'All issues co-mediation -  1 party eligible, agreement on Child only', NULL, 293.00, 710.00, 'MED_FS2013', 'MEDIATION', 'FIXED'),
       ...
       ('MDPS2S', 'Property & Finance sole -  2 parties eligible, with agreed proposal', NULL, 357.00, 777.00, 'MED_FS2013', 'MEDIATION', 'FIXED'),
       ('MDPS1S', 'Property & Finance sole -1 party eligible, with agreed proposal', NULL, 262.50, 472.50, 'MED_FS2013', 'MEDIATION', 'FIXED'),
       ('MDPC2S', 'Property & Finance Co -  2 parties eligible, with agreed proposal', NULL, 419.00, 1023.00, 'MED_FS2013', 'MEDIATION', 'FIXED'),
       ('MDPC1S', 'Property & Finance Co -  1 party eligible, with agreed proposal', NULL, 324.50, 626.50, 'MED_FS2013', 'MEDIATION', 'FIXED'),
