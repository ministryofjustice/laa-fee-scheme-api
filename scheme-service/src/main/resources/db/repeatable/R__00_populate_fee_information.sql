INSERT INTO fee_information (fee_code, fee_description, fee_type, category_type)
...
VALUES ('INVC', 'Police station: attendance', 'FIXED', 'POLICE_STATION'),
       ...
       ('PROE1', 'Representation in the Magistrates Court - category 1A -  lower standard fee - undesignated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROE2', 'Representation in the Magistrates Court - category 1B -  lower standard fee  - undesignated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROE3', 'Representation in the Magistrates Court - category 2 -  lower standard fee - undesignated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROF1', 'Representation in the Magistrates Court - category 1A -  higher standard fee - undesignated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROF2', 'Representation in the Magistrates Court - category 1B -  higher standard fee - undesignated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROF3', 'Representation in the Magistrates Court - category 2 -  higher standard fee - undesignated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROJ1', 'Representation in the Magistrates Court - second claim for deferred sentence - category 1A -  lower standard fee - undesignated area','FIXED', 'MAGISTRATES_COURT'),
       ('PROJ2', 'Representation in the Magistrates Court - second claim for deferred sentence - category 1B -  lower standard fee - undesignated area','FIXED', 'MAGISTRATES_COURT'),
       ('PROJ3', 'Representation in the Magistrates Court - second claim for deferred sentence -  category 1A -  higher standard fee - undesignated area','FIXED', 'MAGISTRATES_COURT'),
       ('PROJ4', 'Representation in the Magistrates Court - second claim for deferred sentence - category 1B -  higher standard fee - undesignated area','FIXED', 'MAGISTRATES_COURT'),
       ('PROJ5', 'Representation in the Magistrates Court - second claim for deferred sentence - category 1A - lower standard fee - designated area','FIXED', 'MAGISTRATES_COURT'),
       ('PROJ6', 'Representation in the Magistrates Court - second claim for deferred sentence - category 1B - lower standard fee - designated area','FIXED', 'MAGISTRATES_COURT'),
       ('PROJ7', 'Representation in the Magistrates Court - second claim for deferred sentence - category 1A -  higher standard fee - designated area','FIXED', 'MAGISTRATES_COURT'),
       ('PROJ8', 'Representation in the Magistrates Court - second claim for deferred sentence - category 1B -  higher standard fee - designated area','FIXED', 'MAGISTRATES_COURT'),
       ('PROK1', 'Representation in the Magistrates Court - category 1A - lower standard fee - designated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROK2', 'Representation in the Magistrates Court - category 1B - lower standard fee - designated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROK3', 'Representation in the Magistrates Court - category 2 - lower standard fee - designated area', 'FIXED', 'MAGISTRATES_COURT')
    ON CONFLICT (fee_code) DO NOTHING;

INSERT INTO fee_information (fee_code, fee_description, fee_type, category_type)
VALUES ('PROL1', 'Representation in the Magistrates Court - category 1A -  higher standard fee - designated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROL2', 'Representation in the Magistrates Court - category 1B -  higher standard fee - designated area', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROL3', 'Representation in the Magistrates Court - category 2 -  higher standard fee - designated area','FIXED', 'MAGISTRATES_COURT'),
       ('PROV1', 'Breach of part 1 injunctions under ASBCP Act - uncontested - lower standard fee', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROV2', 'Breach of part 1 injunctions under ASBCP Act - uncontested - higher standard fee', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROV3', 'Breach of part 1 injunctions under ASBCP Act - contested - lower standard fee', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROV4', 'Breach of part 1 injunctions under ASBCP Act - contested - higher standard fee', 'FIXED', 'MAGISTRATES_COURT'),
       ('PROT', 'Early Cover', 'FIXED', 'EARLY_COVER'),
       ...
       ('YOUE1', 'Youth Representation Order - category 1A - lower standard fee - undesignated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUE2', 'Youth Representation Order - category 1B - lower standard fee - undesignated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUE3', 'Youth Representation Order - category 2A - lower standard fee - undesignated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUE4', 'Youth Representation Order - category 2B - lower standard fee - undesignated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUF1', 'Youth Representation Order - category 1A - higher standard fee - undesignated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUF2', 'Youth Representation Order - category 1B - higher standard fee - undesignated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUF3', 'Youth Representation Order - category 2A - higher standard fee - undesignated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUF4', 'Youth Representation Order - category 2B - higher standard fee - undesignated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUK1', 'Youth Representation Order - category 1A - lower standard fee - designated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUK2', 'Youth Representation Order - category 1B - lower standard fee - designated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUK3', 'Youth Representation Order - category 2A - lower standard fee - designated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUK4', 'Youth Representation Order - category 2B - lower standard fee - designated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUL1', 'Youth Representation Order - category 1A - higher standard fee - designated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUL2', 'Youth Representation Order - category 1B - higher standard fee - designated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUL3', 'Youth Representation Order - category 2A - higher standard fee - designated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUL4', 'Youth Representation Order - category 2B - higher standard fee - designated area', 'FIXED', 'YOUTH_COURT'),
       ('YOUX1', 'Youth Representation Order - second claim for deferred sentence - category 1A - lower standard fee - undesignated area','FIXED', 'YOUTH_COURT'),
       ('YOUX2', 'Youth Representation Order - second claim for deferred sentence - category 1B - lower standard fee - undesignated area','FIXED', 'YOUTH_COURT')
    ON CONFLICT (fee_code) DO NOTHING;

INSERT INTO fee_information (fee_code, fee_description, fee_type, category_type)
VALUES ('YOUX3','Youth Representation Order - second claim for deferred sentence - category 1A - higher standard fee - undesignated area','FIXED', 'YOUTH_COURT'),
       ('YOUX4','Youth Representation Order - second claim for deferred sentence - category 1B - higher standard fee - undesignated area','FIXED', 'YOUTH_COURT'),
       ('YOUY1','Youth Representation Order - second claim for deferred sentence - category 1A - lower standard fee - designated area','FIXED', 'YOUTH_COURT'),
       ('YOUY2','Youth Representation Order - second claim for deferred sentence - category 1B - lower standard fee - designated area','FIXED', 'YOUTH_COURT'),
       ('YOUY3','Youth Representation Order - second claim for deferred sentence - category 1A - higher standard fee - designated area','FIXED', 'YOUTH_COURT'),
       ('YOUY4','Youth Representation Order - second claim for deferred sentence - category 1B - higher standard fee - designated area','FIXED', 'YOUTH_COURT')
    ON CONFLICT (fee_code) DO NOTHING;

INSERT INTO fee_information (fee_code, fee_description, fee_type, category_type)
VALUES ('PRIA', 'Free Standing Advice and Assistance', 'FIXED', 'PRISON_LAW'),
       ('PRIB1', 'Disciplinary Cases – Advocacy Assistance - lower standard fee', 'FIXED', 'PRISON_LAW'),
       ('PRIB2', 'Disciplinary Cases – Advocacy Assistance - higher standard fee', 'FIXED', 'PRISON_LAW'),
       ('PRIC1', 'Parole Board Cases – Advocacy Assistance - lower standard fee', 'FIXED', 'PRISON_LAW'),
       ('PRIC2', 'Parole Board Cases – Advocacy Assistance - higher standard fee', 'FIXED', 'PRISON_LAW'),
       ('PRID1', 'Advocacy Assistance at Sentence Reviews - lower standard fee', 'FIXED', 'PRISON_LAW'),
       ('PRID2', 'Advocacy Assistance at Sentence Reviews - higher standard fee', 'FIXED', 'PRISON_LAW'),
       ('PRIE1', 'Advocacy Assistance at Parole Board Reconsideration Hearings - lower standard fee', 'FIXED', 'PRISON_LAW'),
       ('PRIE2', 'Advocacy Assistance at Parole Board Reconsideration Hearings - higher standard fee', 'FIXED', 'PRISON_LAW'),
