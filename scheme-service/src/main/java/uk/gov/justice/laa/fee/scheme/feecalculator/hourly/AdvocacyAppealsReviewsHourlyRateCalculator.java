...
public class AdvocacyAppealsReviewsHourlyRateCalculator implements FeeCalculator {
  ...
  public FeeCalculationResponse calculate(FeeCalculationRequest feeCalculationRequest, FeeEntity feeEntity) {
    ...
    BigDecimal disbursementVatAmount = Boolean.TRUE.equals(vatIndicator)
        ...
        : requestedNetDisbursementVatAmount;
    ...
    return FeeCalculationUtil.buildFeeCalculationResponse(feeCalculationRequest, feeEntity, feeCalculation, validationMessages);
  }
}