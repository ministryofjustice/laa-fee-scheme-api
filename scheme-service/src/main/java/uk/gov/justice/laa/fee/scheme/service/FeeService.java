...
public class FeeService {
  ...
  private FeeCalculationResponse getCalculation(FeeEntity feeEntity, PoliceStationFeesEntity policeStationFeesEntity,
    ...
    return switch (feeEntity.getCalculationType()) {
      ...
      case POLICE_STATION -> {
        if (feeEntity.getFeeType().equals("FIXED")) {
          yield PoliceStationFixedFeeCalculator.getFee(feeEntity, policeStationFeesEntity,
              feeCalculationRequest);
        } else {
          yield PoliceStationHourlyFeeCalculator.getFee(feeEntity, feeCalculationRequest);
        }
      }
    };
  }
