...
/**
 * Warning Codes for Business Rules Validations.
 */
...
public enum WarningCode {
  ...
  WARN_IMM_ASYLM_ESCAPE_THRESHOLD("WARIA3", "Immigration & Asylum escape case threshold",
      CategoryType.IMMIGRATION_ASYLUM),
  WARN_MENTAL_HEALTH_ESCAPE_THRESHOLD("WARMH1", "Mental Health escape case threshold",
  ...
  WARN_HOUSING_ESCAPE_THRESHOLD("WAROTH8", "Other Civil - Housing escape case threshold",
      CategoryType.HOUSING),
  WARN_MISCELLANEOUS_ESCAPE_THRESHOLD("WAROTH9", "Other Civil - Miscellaneous escape case threshold",
      CategoryType.MISCELLANEOUS),
  WARN_PUBLIC_LAW_ESCAPE_THRESHOLD("WAROTH10", "Other Civil - Public Law (Non-Family) escape case "
      + "threshold", CategoryType.PUBLIC_LAW),
  WARN_WELFARE_BENEFITS_ESCAPE_THRESHOLD("WAROTH11", "Other Civil - Welfare Benefits escape case "
      + "threshold", CategoryType.WELFARE_BENEFITS);
